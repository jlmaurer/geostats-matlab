function d = L2_distance(x,y,df)
% L2_DISTANCE - computes Euclidean distance matrix
%
% E = L2_distance(A,B)
%
%    A - (MxD) matrix, D the # of dimensions
%    B - (NxD) matrix
...
% Modified : Jeremy Maurer, April 17, 2017
...
% modify to keep in line with other geostats codes
x = x'; y = y'; 
